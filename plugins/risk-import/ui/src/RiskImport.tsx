...
const { React, mui, lucideReact, services } = window.VerifyWise;
...
const { Download, Upload, FileText, CheckCircle, XCircle } = lucideReact;
...
const RiskImport = ({ onImportComplete }: RiskImportProps) => {
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      const response = await apiServices.post("/plugins/risk-import/import", {
        csvData: excelData,
      });
